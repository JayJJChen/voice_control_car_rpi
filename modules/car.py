...
class Car:
    def __init__(self):
        ...
        self.front_left = Wheel(
            WHEEL_PINS['FRONT_LEFT'][0], WHEEL_PINS['FRONT_LEFT'][1])
        self.front_right = Wheel(
            WHEEL_PINS['FRONT_RIGHT'][0], WHEEL_PINS['FRONT_RIGHT'][1])
        self.back_left = Wheel(
            WHEEL_PINS['BACK_LEFT'][0], WHEEL_PINS['BACK_LEFT'][1])
        self.back_right = Wheel(
            WHEEL_PINS['BACK_RIGHT'][0], WHEEL_PINS['BACK_RIGHT'][1])
